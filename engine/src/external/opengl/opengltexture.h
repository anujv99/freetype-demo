...
namespace engine { namespace external { namespace opengl {
	...
	public:
		...
		OpenGLTexture(Vec2i size, const unsigned char * buffer, graphics::TextureParams params);
		~OpenGLTexture();
	public:
		...
		virtual uintptr_t GetNativeTexture() const override { return (uintptr_t)m_ID; }
	public:
