...
namespace engine {
	...
	namespace graphics {
		utils::StrongHandle<VertexShader> VertexShader::Create(const char * source) {
			return dynamic_cast<VertexShader *>(new engine::external::opengl::OpenGLVertexShader(source));
		}
	}
	...
	namespace graphics {
		utils::StrongHandle<FragmentShader> FragmentShader::Create(const char * source) {
			return dynamic_cast<FragmentShader *>(new engine::external::opengl::OpenGLFragmentShader(source));
		}
	}
	...
	namespace graphics {
		utils::StrongHandle<ShaderProgram> ShaderProgram::Create(utils::StrongHandle<VertexShader> vShader, utils::StrongHandle<FragmentShader> fShader) {
			return dynamic_cast<ShaderProgram *>(new engine::external::opengl::OpenGLShaderProgram(vShader, fShader));
		}
	}
