...
namespace engine { namespace external { namespace opengl {
	...
	GLenum OpenGLHelper::GetOpenGLType(graphics::ExternalTextureFormat format) {
		switch (format) {
		case graphics::ExternalTextureFormat::R:	return GL_RED;
		case graphics::ExternalTextureFormat::RG:	return GL_RG;
		case graphics::ExternalTextureFormat::RGB:	return GL_RGB;
		case graphics::ExternalTextureFormat::RGBA:	return GL_RGBA;
		}
	...
	GLenum OpenGLHelper::GetOpenGLType(graphics::ExternalDataType dataType) {
		switch (dataType) {
		case engine::graphics::ExternalDataType::FLOAT:			return GL_FLOAT;
		case engine::graphics::ExternalDataType::UNSIGNED_BYTE:	return GL_UNSIGNED_BYTE;
		}

		ASSERTM(false, "[OpenGL] Invalid External Data Type");
		return GL_INVALID_ENUM;
	}

	GLenum OpenGLHelper::GetOpenGLType(graphics::InternalTextureFormat format) {
		switch (format) {
		case graphics::InternalTextureFormat::R:			return GL_R8;
		case graphics::InternalTextureFormat::RG:			return GL_RG8;
		case graphics::InternalTextureFormat::RGB:			return GL_RGB8;
		case graphics::InternalTextureFormat::RGBA:			return GL_RGBA8;
		case graphics::InternalTextureFormat::R32F:			return GL_R32F;
		case graphics::InternalTextureFormat::RG32F:		return GL_RG32F;
		case graphics::InternalTextureFormat::RGB32F:		return GL_RGB32F;
		case graphics::InternalTextureFormat::RGBA32F:		return GL_RGBA32F;
		}

		ASSERTM(false, "[OpenGL] Invalid Internal Texture Format");
		return GL_INVALID_ENUM;
	}

	unsigned int OpenGLHelper::GetNumBytes(graphics::ExternalTextureFormat format) {
		switch (format) {
		case graphics::ExternalTextureFormat::R:	return 1u;
		case graphics::ExternalTextureFormat::RG:	return 2u;
		case graphics::ExternalTextureFormat::RGB:	return 3u;
		case graphics::ExternalTextureFormat::RGBA:	return 4u;
		}
