...
namespace engine { namespace external { namespace glfw {
    ...
    public:
        ...
        virtual void SetEventFunction(std::function<void(engine::core::events::Event &)> eventFunc) override;
    ...
    private:
        ...
        struct WindowData {
            ...
            std::string Title;
            std::function<void(engine::core::events::Event &)> EventFunc;
        };
