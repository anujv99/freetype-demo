...
namespace engine {
	...
	namespace core {
        ...
        class Window : public engine::utils::Singleton<Window> {
            friend class engine::utils::Singleton<Window>;
        protected:
            Window() {}
            virtual ~Window() {}
        public:
    ...
    namespace utils {
        ...
        template<>
        inline void Singleton<engine::core::Window>::CreateInst() {
            if (!s_Instance) s_Instance = engine::core::Window::CreateWindow();
        }
